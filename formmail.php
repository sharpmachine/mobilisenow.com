...
$TARGET_EMAIL = array(EMAIL_NAME."@mobilisenow\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","jessekade@gmail.com");
...
$ATTACK_DETECTION_DUPS = array("Name","address1","address2","country","zip",
                        ...
                        $s_to,$s_cc,$s_bcc,$a_raw_fields,$s_filter,$a_filter_list)
{
    ...
    if (!$b_used_template)
    {
        ...
        if (IsMailOptionSet("DupHeader"))
        {
            ...
            //
            // put the Name and the email address at the top of the results
            // (if not excluded)
            //
