...
<div class="row">
    <form class="form-horizontal" role="form" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>" method="post">
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text" class="form-control" name="hwct-fb-app-id" placeholder="Enter Facebook App ID here" value="<?php echo $hwctOptions["hwct-fb-app-id"]; ?>" />
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-4">
                <input type="text" class="form-control" name="hwct-fb-app-scrt" placeholder="Enter Facebook Secret here" value="<?php echo $hwctOptions["hwct-fb-app-scrt"] ?>" />
            </div>
        </div><!--End of form group -->
