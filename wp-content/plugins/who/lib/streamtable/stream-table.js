...
(function(window, $) {
  ...
  _F.initPagination = function(opts){
    ...
    var p_classes = ['st_pagination'+Math.floor(Math.random() * (10 - 1) + 1)];
    ...
    this.paging_opts.ul_class = ['pagination'+Math.floor(Math.random() * (10 - 1) + 1), opts.ul_class].join(' ');
  ...
  _F.addSearchBox = function(){
    ...
    $(this.main_container).before('<input name="search" type="text" class="st_search" placeholder="Type here...">');
