<?php get_header(); ?>
	...
	<?php if (have_posts()) : ?>
		...
		<h2><?php _e('Search Results for:','ndesignthemes'); ?> <em><?php echo $s; ?></em></h2>
	...
	<?php else : ?>
		...
		<h2><?php _e('Sorry','ndesignthemes'); ?></h2>
		<p><?php _e('No posts found. Please try a different keyword','ndesignthemes'); ?></p>
