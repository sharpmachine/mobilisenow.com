...
<?php if ( have_comments() ) : ?>
	<h4 id="comments"><?php comments_number(__('No Comments','ndesignthemes'), __('One Comment','ndesignthemes'), __('% Comments','ndesignthemes') );?> <em>(<a href="#respond"><?php _e('+add yours?','ndesignthemes') ?></a>)</em></h4>
...
<h4><?php comment_form_title( __('Leave a Reply','ndesignthemes'), __('Leave a Reply to <em>%s</em>','ndesignthemes') ); ?></h4>
...
<label for="author"><?php _e('Name','ndesignthemes');?> <small><?php if ($req) _e('(required)','ndesignthemes'); ?></small></label></p>

<p><input type="text" name="email" id="email" value="<?php echo esc_attr($comment_author_email); ?>" size="22" tabindex="2" <?php if ($req) echo "aria-required='true'"; ?> />
<label for="email">Mail <small><?php if ($req) _e('(required)','ndesignthemes'); ?></small></label></p>

<p><input type="text" name="url" id="url" value="<?php echo esc_attr($comment_author_url); ?>" size="22" tabindex="3" />
<label for="url"><?php _e('Website','ndesignthemes'); ?></label></p>
...
<p><input name="submit" type="submit" id="submit" tabindex="5" value="<?php _e('Submit Comment','ndesignthemes'); ?>" />
